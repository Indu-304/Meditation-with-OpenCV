...
prev_position = None
movement_threshold = 50  # Adjust this threshold

last_movement_warning_time = 0
movement_cooldown_period = 5  # Cooldown period for movement voice warnings
last_emotion_warning_time = 0
emotion_cooldown_period = 5  # Cooldown period for emotion voice warnings
...
while True:
    ...
    for subject in subjects:
        ...
        if emotion and emotion_score > 0.7 and emotion not in ["happy", "neutral"]:
            ...
            # cv2.putText(frame, warning_text, (text_x, text_y), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
            if ear < thresh:
        ...
        if prev_position is not None:
            ...
            if movement > movement_threshold:
                ...
                # cv2.putText(frame, movement_text, (text_x, text_y), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
    ...
    # cv2.putText(frame, noise_text, (frame.shape[1] - 300, frame.shape[0] - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
    if noise_level > 80:
        put_text_with_shadow(frame, "Noise is greater than recommended level", 10, frame.shape[0] - 10, 1, (255, 255, 255), 2)
        # cv2.putText(frame, "Noise is greater than recommended level", (frame.shape[1] - 900, frame.shape[0] - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
